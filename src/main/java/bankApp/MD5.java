...
public class MD5 {
	...
	private  int kConstantPosition;
	private   int shiftValuePosition;
	private int messageBytePosition;
	private Long functionResult;  
